...
import com.example.proyectofinal_moviles.ui.Favoritos.FavoritosFragment
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val productos = listOf(
            producto(R.drawable.prod1, "Compactadora", "Marca A", "Modelo B", "$550", 1),
            producto(R.drawable.prod1, "Compactadora2", "Marca C", "Modelo D", "$2000", 2),
